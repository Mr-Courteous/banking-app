...
const connect = 'mongodb+srv://Courteous:mongokey@cluster0.qiuqa3p.mongodb.net/BankingApp?retryWrites=true&w=majority';
...
const connectDB = async () => {
    try {
        ...
        console.log('Connected to BankingApp Database');
    } catch (error) {
